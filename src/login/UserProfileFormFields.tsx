                    ...
                    <Fragment key={attribute.name}>
                        ...
                        >
                            <div className={kcClsx("kcLabelWrapperClass")}>
                                <label htmlFor={attribute.name} className="Input-label-text">
...
function InputTag(props: InputFieldByTypeProps & { fieldIndex: number | undefined }) {
    ...
    // config do input tipo password

    const inputType = attribute.name;
    ...
    // fim config do input tipo password
        ...
        <>
            ...
            <OutlinedInput
                ...
                endAdornment={
                    ...
                    ) : inputType === "password" || inputType === "password-confirm" ? (
                        <InputAdornment position="end">
                            <IconButton
